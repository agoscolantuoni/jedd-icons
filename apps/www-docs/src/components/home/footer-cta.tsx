...
import { IconCloud } from "@/components/home/icon-cloud";
...
export function FooterCta() {
  return (
    <section className="relative flex min-h-80 items-center justify-center overflow-hidden border-border border-b px-6 py-20 text-center">
      <IconCloud />
